...
# Help the dealer find out which car has an id of 33 by logging the car's year, make, and model in the print statement provided below:
print(f"Car 33 is a *car year goes here* *car make goes here* *car model goes here*")
...
# Sort all the car model names into alphabetical order and print the results
car_models = []
car_models_sorted = []
print()
...
# Create a new array from the dealer data containing only the car years and print the result.
car_years = []
print()

# ==== Challenge 5 ====
# The car lot manager needs to find out how many cars are older than the year 2000.
# Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the list old_cars and logging it's length.
old_cars = []
print()

# ==== Challenge 6 ====
# A buyer is interested in seeing only BMW and Audi cars within the inventory.
# Return an array that only contains BMW and Audi cars, and print the result
bmw_and_audi = []
print()
