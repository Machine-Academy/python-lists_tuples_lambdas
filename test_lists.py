...
class TestLists(unittest.TestCase):
    ...
    def test_find_car_by_id(self):
        self.assertTrue("find_car_by_id" in dir(sample))
        self.assertTrue(hasattr(sample, "find_car_by_id"))
        self.assertTrue(isfunction(sample.find_car_by_id))

        expected = "Car 33 is a 2011 Jeep Wrangler"
        actual = sample.find_car_by_id(33, self.inventory)
